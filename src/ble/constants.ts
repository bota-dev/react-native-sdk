...
/** P9.F2: SHA-256 packet emitted after EOF. Legacy layout is
 *  [0x04, sha256[32]]; fixed firmware appends recording_id[16]. Old SDKs
 *  continue consuming the first 33 bytes. */
