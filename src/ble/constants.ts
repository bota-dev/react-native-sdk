...
export const SERVICE_BOTA_DIAGNOSTICS = 'B07A0007-0000-1000-8000-00805F9B34FB';
...
/** Deprecated certificate-delivery compatibility characteristic.
 *  The current target certificate profile uses a device-generated,
 *  non-exportable private key and never relays reusable private-key material
 *  through the backend, App, or SDK. */
...
export const CHAR_STORAGE_TRANSFER_CAPABILITIES_V2 = 'B07A0004-0006-1000-8000-00805F9B34FB';
export const CHAR_TRANSFER_SIGNED_BLOB_V2 = 'B07A0004-0007-1000-8000-00805F9B34FB';
export const CHAR_TRANSFER_CONTROL_V2 = 'B07A0004-0008-1000-8000-00805F9B34FB';
export const CHAR_RECORDING_TRANSFER_V2 = 'B07A0004-0009-1000-8000-00805F9B34FB';
export const CHAR_TRANSFER_STATUS_V2 = 'B07A0004-000A-1000-8000-00805F9B34FB';
export const CHAR_RECORDING_LIST_V2 = 'B07A0004-000B-1000-8000-00805F9B34FB';
export const CHAR_UPLOAD_CONTEXT_V2 = 'B07A0004-000C-1000-8000-00805F9B34FB';
 ...
 *  before BLE transfer. Lives in the Auth service since it's a crypto key. */
export const CHAR_BACKEND_PUBKEY = 'B07A0005-0003-1000-8000-00805F9B34FB';
...
// Bota Diagnostics Service Characteristics (B07A0007)
export const CHAR_DEVICE_LOG_CONTROL = 'B07A0007-0001-1000-8000-00805F9B34FB';
export const CHAR_DEVICE_LOG_DATA = 'B07A0007-0002-1000-8000-00805F9B34FB';

// Device log control commands
export const DEVICE_LOG_CMD_STOP = 0x00;
export const DEVICE_LOG_CMD_START = 0x01;
...
export const PROVISIONING_RESET_PENDING = 0x06;
export const PROVISIONING_RESET_FINALIZED = 0x07;
